...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Local TSTP Endpoint Configuration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.cloudtresor.model.proxy.endpoint.impl.LocalTSTPEndpointConfigurationImpl#getTstpConfiguration <em>Tstp Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LocalTSTPEndpointConfigurationImpl extends LocalSSLEndpointConfigurationImpl implements LocalTSTPEndpointConfiguration {
	/**
	 ...
	 * @generated
	 */
	protected LocalTSTPEndpointConfigurationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EndpointPackage.Literals.LOCAL_TSTP_ENDPOINT_CONFIGURATION;
	}
		...
		if (tstpConfiguration != null && tstpConfiguration.eIsProxy()) {
			...
			if (tstpConfiguration != oldTstpConfiguration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EndpointPackage.LOCAL_TSTP_ENDPOINT_CONFIGURATION__TSTP_CONFIGURATION, oldTstpConfiguration, tstpConfiguration));
			}
		}
	...
	public void setTstpConfiguration(ClientSSLConfiguration newTstpConfiguration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EndpointPackage.LOCAL_TSTP_ENDPOINT_CONFIGURATION__TSTP_CONFIGURATION, oldTstpConfiguration, tstpConfiguration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EndpointPackage.LOCAL_TSTP_ENDPOINT_CONFIGURATION__TSTP_CONFIGURATION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TSTPEndpointConfiguration.class) {
			switch (derivedFeatureID) {
				case EndpointPackage.LOCAL_TSTP_ENDPOINT_CONFIGURATION__TSTP_CONFIGURATION: return EndpointPackage.TSTP_ENDPOINT_CONFIGURATION__TSTP_CONFIGURATION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TSTPEndpointConfiguration.class) {
			switch (baseFeatureID) {
				case EndpointPackage.TSTP_ENDPOINT_CONFIGURATION__TSTP_CONFIGURATION: return EndpointPackage.LOCAL_TSTP_ENDPOINT_CONFIGURATION__TSTP_CONFIGURATION;
				default: return -1;
			}
		}
...
} //LocalTSTPEndpointConfigurationImpl
