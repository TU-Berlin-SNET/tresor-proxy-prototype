...
public class ProxyFactoryImpl extends EFactoryImpl implements ProxyFactory {
	...
	public static ProxyFactory init() {
		try {
			ProxyFactory theProxyFactory = (ProxyFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.cloud-tresor.de/model/proxy"); 
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ProxyPackage.URL:
				return createURLFromString(eDataType, initialValue);
			case ProxyPackage.CERTIFICATE:
				return createCertificateFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ProxyPackage.CERTIFICATE:
				return convertCertificateToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Certificate createCertificateFromString(EDataType eDataType, String initialValue) {
		return (Certificate)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertCertificateToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
